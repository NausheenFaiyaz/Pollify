...
Pollify uses a custom OpenID Connect-compatible auth provider:
...
- Login through TokenShinobi OIDC.
...
Built with care using a custom OIDC stack powered by **TokenShinobi**:  
